...
pub struct Arguments {
    ...
    ```console
        ...
        efd_contribuicoes --generate=zsh > completion_derive.zsh

    ```

    Append the contents of the completion_derive.zsh file to the end of
    ~/.oh-my-zsh/lib/completion.zsh
    or another completion.zsh file.
    ...
    To use these completions, you must either add the generated script
