use crate::{EFDError, EFDResult, SpedRecordTrait, blocos::*, impl_bloco_methods};
use rayon::prelude::*;
...
impl SpedRecord {
    ...
    pub fn line_number(&self) -> usize {
        match self {
            Self::Bloco0(b) => b.line_number(),
            Self::Bloco1(b) => b.line_number(),
            Self::Bloco9(b) => b.line_number(),
            Self::BlocoA(b) => b.line_number(),
            Self::BlocoC(b) => b.line_number(),
            Self::BlocoD(b) => b.line_number(),
            Self::BlocoF(b) => b.line_number(),
            Self::BlocoI(b) => b.line_number(),
            Self::BlocoM(b) => b.line_number(),
            Self::BlocoP(b) => b.line_number(),
        }
    }
    ...
    pub fn registro_name(&self) -> &str {
        match self {
            Self::Bloco0(b) => b.registro_name(),
            Self::Bloco1(b) => b.registro_name(),
            Self::Bloco9(b) => b.registro_name(),
            Self::BlocoA(b) => b.registro_name(),
            Self::BlocoC(b) => b.registro_name(),
            Self::BlocoD(b) => b.registro_name(),
            Self::BlocoF(b) => b.registro_name(),
            Self::BlocoI(b) => b.registro_name(),
            Self::BlocoM(b) => b.registro_name(),
            Self::BlocoP(b) => b.registro_name(),
        }
    }
    ...
    pub fn as_any(&self) -> &dyn std::any::Any {
        match self {
            Self::Bloco0(b) => b.as_any(),
            Self::BlocoA(b) => b.as_any(),
            Self::BlocoC(b) => b.as_any(),
            Self::BlocoD(b) => b.as_any(),
            Self::BlocoF(b) => b.as_any(),
            Self::BlocoI(b) => b.as_any(),
            Self::BlocoM(b) => b.as_any(),
            Self::BlocoP(b) => b.as_any(),
            Self::Bloco1(b) => b.as_any(),
            Self::Bloco9(b) => b.as_any(),
        }
    }
    ...
    pub fn as_any_mut(&mut self) -> &mut dyn std::any::Any {
        match self {
            Self::Bloco0(b) => b.as_any_mut(),
            Self::BlocoA(b) => b.as_any_mut(),
            Self::BlocoC(b) => b.as_any_mut(),
            Self::BlocoD(b) => b.as_any_mut(),
            Self::BlocoF(b) => b.as_any_mut(),
            Self::BlocoI(b) => b.as_any_mut(),
            Self::BlocoM(b) => b.as_any_mut(),
            Self::BlocoP(b) => b.as_any_mut(),
            Self::Bloco1(b) => b.as_any_mut(),
            Self::Bloco9(b) => b.as_any_mut(),
        }
    }

    /// Tenta converter (downcast) o registro genérico para uma referência do tipo concreto T.
    ///
    ...
    pub fn downcast_ref<T: 'static>(&self) -> EFDResult<&T> {
        ...
        any.downcast_ref::<T>()
            .ok_or_else(|| EFDError::RecordCastError(self.registro_name().to_string()))
    }
    ...
    pub fn println(&self) {
        match self {
            ...
            Self::Bloco0(reg) => println!("{reg:#?}"),
            Self::Bloco1(reg) => println!("{reg:#?}"),
            Self::Bloco9(reg) => println!("{reg:#?}"),
            Self::BlocoA(reg) => println!("{reg:#?}"),
            Self::BlocoC(reg) => println!("{reg:#?}"),
            Self::BlocoD(reg) => println!("{reg:#?}"),
            Self::BlocoF(reg) => println!("{reg:#?}"),
            Self::BlocoI(reg) => println!("{reg:#?}"),
            Self::BlocoM(reg) => println!("{reg:#?}"),
            Self::BlocoP(reg) => println!("{reg:#?}"),
        }
    }
...
impl_bloco_methods!(Bloco0 {
    R0000 => "0000", R0001 => "0001", R0035 => "0035", R0100 => "0100", R0110 => "0110",
    R0111 => "0111", R0120 => "0120", R0140 => "0140", R0145 => "0145", R0150 => "0150",
    R0190 => "0190", R0200 => "0200", R0205 => "0205", R0206 => "0206", R0208 => "0208",
    R0400 => "0400", R0450 => "0450", R0500 => "0500", R0600 => "0600", R0900 => "0900",
    R0990 => "0990",
});
...
impl_bloco_methods!(BlocoA {
    RA001 => "A001", RA010 => "A010", RA100 => "A100", RA110 => "A110",
    RA111 => "A111", RA120 => "A120", RA170 => "A170", RA990 => "A990",
});
...
impl_bloco_methods!(BlocoC {
    RC001 => "C001", RC010 => "C010", RC100 => "C100", RC110 => "C110", RC111 => "C111",
    RC120 => "C120", RC170 => "C170", RC175 => "C175", RC180 => "C180", RC181 => "C181",
    RC185 => "C185", RC188 => "C188", RC190 => "C190", RC191 => "C191", RC195 => "C195",
    RC198 => "C198", RC199 => "C199", RC380 => "C380", RC381 => "C381", RC385 => "C385",
    RC395 => "C395", RC396 => "C396", RC400 => "C400", RC405 => "C405", RC481 => "C481",
    RC485 => "C485", RC489 => "C489", RC490 => "C490", RC491 => "C491", RC495 => "C495",
    RC499 => "C499", RC500 => "C500", RC501 => "C501", RC505 => "C505", RC509 => "C509",
    RC600 => "C600", RC601 => "C601", RC605 => "C605", RC609 => "C609", RC800 => "C800",
    RC810 => "C810", RC820 => "C820", RC830 => "C830", RC860 => "C860", RC870 => "C870",
    RC880 => "C880", RC890 => "C890", RC990 => "C990",
});
...
impl_bloco_methods!(BlocoD {
    RD001 => "D001", RD010 => "D010", RD100 => "D100", RD101 => "D101", RD105 => "D105",
    RD111 => "D111", RD200 => "D200", RD201 => "D201", RD205 => "D205", RD209 => "D209",
    RD300 => "D300", RD309 => "D309", RD350 => "D350", RD359 => "D359", RD500 => "D500",
    RD501 => "D501", RD505 => "D505", RD509 => "D509", RD600 => "D600", RD601 => "D601",
    RD605 => "D605", RD609 => "D609", RD990 => "D990",
});
...
impl_bloco_methods!(BlocoF {
    RF001 => "F001", RF010 => "F010", RF100 => "F100", RF111 => "F111", RF120 => "F120",
    RF129 => "F129", RF130 => "F130", RF139 => "F139", RF150 => "F150", RF200 => "F200",
    RF205 => "F205", RF210 => "F210", RF211 => "F211", RF500 => "F500", RF509 => "F509",
    RF510 => "F510", RF519 => "F519", RF525 => "F525", RF550 => "F550", RF559 => "F559",
    RF560 => "F560", RF569 => "F569", RF600 => "F600", RF700 => "F700", RF800 => "F800",
    RF990 => "F990",
});
...
impl_bloco_methods!(BlocoI {
    RI001 => "I001", RI010 => "I010", RI100 => "I100", RI199 => "I199",
    RI200 => "I200", RI299 => "I299", RI300 => "I300", RI399 => "I399", RI990 => "I990",
});
...
pub enum BlocoM {
    ...
    RM205(RegistroM205),
    RM210(RegistroM210),
    RM210Antigo(RegistroM210Antigo),
    RM211(RegistroM211),
    RM215(RegistroM215),
    RM220(RegistroM220),
    RM225(RegistroM225),
    ...
    RM605(RegistroM605),
    RM610(RegistroM610),
    RM610Antigo(RegistroM610Antigo),
    RM611(RegistroM611),
    RM615(RegistroM615),
    RM620(RegistroM620),
    RM625(RegistroM625),
...
impl_bloco_methods!(BlocoM {
    RM001 => "M001", RM100 => "M100", RM105 => "M105", RM110 => "M110", RM115 => "M115",
    RM200 => "M200", RM205 => "M205", RM210 => "M210", RM210Antigo => "M210",
    RM211 => "M211", RM215 => "M215", RM220 => "M220", RM225 => "M225", RM230 => "M230",
    RM300 => "M300", RM350 => "M350", RM400 => "M400", RM410 => "M410", RM500 => "M500",
    RM505 => "M505", RM510 => "M510", RM515 => "M515", RM600 => "M600", RM605 => "M605",
    RM610 => "M610", RM610Antigo => "M610", RM611 => "M611", RM615 => "M615",
    RM620 => "M620", RM625 => "M625", RM630 => "M630", RM700 => "M700", RM800 => "M800",
    RM810 => "M810", RM990 => "M990",
});
...
impl_bloco_methods!(BlocoP {
    RP001 => "P001", RP010 => "P010", RP100 => "P100", RP110 => "P110",
    RP199 => "P199", RP200 => "P200", RP210 => "P210", RP990 => "P990",
});
...
impl_bloco_methods!(Bloco1 {
    R1001 => "1001", R1010 => "1010", R1011 => "1011", R1020 => "1020", R1050 => "1050",
    R1100 => "1100", R1101 => "1101", R1102 => "1102", R1200 => "1200", R1210 => "1210",
    R1220 => "1220", R1300 => "1300", R1500 => "1500", R1501 => "1501", R1502 => "1502",
    R1600 => "1600", R1610 => "1610", R1620 => "1620", R1700 => "1700", R1800 => "1800",
    R1809 => "1809", R1900 => "1900", R1990 => "1990",
});
...
impl_bloco_methods!(Bloco9 {
    R9001 => "9001", R9900 => "9900", R9990 => "9990", R9999 => "9999",
});
...
impl SpedFile {
    ...
    pub fn obter_registro<T: 'static>(&self, nome_reg: &str) -> EFDResult<&T> {
        let bloco_char = nome_reg
            .chars()
            .next()
            .ok_or_else(|| EFDError::KeyNotFound(nome_reg.to_string()))?;
        ...
        macro_rules! find_and_cast {
            ($bloco_vec:expr) => {
                $bloco_vec
                    ...
                    .ok_or_else(|| EFDError::RecordNotFound(nome_reg.to_string()))?
                    .as_any()
                    .downcast_ref::<T>()
                    .ok_or_else(|| EFDError::RecordCastError(nome_reg.to_string()))
            };
        }
        ...
        match bloco_char {
            ...
            _ => Err(EFDError::KeyNotFound(nome_reg.to_string())),
        }
    }
        ...
        T: SpedRecordTrait + std::fmt::Debug,
    {
        ...
        // Imprime apenas os 5 primeiros
        for rec in registros.iter().take(5) {
            println!(
                "  [{:4}] L{: <5} {:?}",
                rec.registro_name(),
                rec.line_number(),
