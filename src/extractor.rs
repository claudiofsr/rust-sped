...
use crate::{
    ...
    CodigoSituacaoTributaria, DECIMAL_VALOR, DecimalExt, DocsFiscais, IndicadorDeOrigem,
    MesesDoAno, ModeloDocFiscal, NaturezaBaseCalculo, SpedContext, SpedFile, SpedRecordTrait,
    StringParser, TipoDeCredito, TipoDeOperacao, TipoDeRateio, TipoDoItem, blocos::*, capture_cnpj,
    cred_presumido, impl_dopai, impl_filho, obter_natureza_da_bc, obter_pis_da_tabela_estatica,
        ...
        for bloco_1 in records {
            match bloco_1 {
                ...
                Bloco1::R1100(r) => {
                    ...
                    if let (Some(doc), Some(msg)) = mappers::build_ctrl_credito(
                        r.line_number,
                        "1100",
