...
pub struct RegistroC880 {
    ...
    pub quant_bc_pis: Option<Arc<str>>,     // 7 (Pode ser String ou Decimal)
    pub aliq_pis_quant: Option<Decimal>,    // 8
    pub vl_pis: Option<Decimal>,            // 9
    pub cst_cofins: Option<u16>,            // 10
    pub quant_bc_cofins: Option<Arc<str>>,  // 11 (Pode ser String ou Decimal)
...
impl SpedParser for RegistroC880 {
    ...
    fn parse_reg(file_path: &Path, line_number: usize, fields: &[&str]) -> EFDResult<Self::Output> {
        ...
        let quant_bc_cofins = fields.get(11).to_arc();
