...
pub struct RegistroC600 {
    ...
    pub cod_mun: Option<Arc<str>>,      // 3
    pub ser: Option<Arc<str>>,          // 4
    pub sub: Option<Arc<str>>,          // 5
    pub cod_cons: Option<Arc<str>>,     // 6
    pub qtd_cons: Option<Arc<str>>,     // 7 (Assumindo que QTD pode ser string se for só int)
    pub qtd_canc: Option<Arc<str>>,     // 8 (Assumindo que QTD pode ser string se for só int)
    pub dt_doc: Option<NaiveDate>,      // 9
    pub vl_doc: Option<Decimal>,        // 10
    pub vl_desc: Option<Decimal>,       // 11
    pub cons: Option<Arc<str>>,         // 12
...
impl SpedParser for RegistroC600 {
    ...
    fn parse_reg(file_path: &Path, line_number: usize, fields: &[&str]) -> EFDResult<Self::Output> {
        ...
        let cod_mun = fields.get(3).to_arc();
