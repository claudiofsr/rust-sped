...
const REGISTRO: &str = "D205";

#[derive(Debug, Clone)]
pub struct RegistroD205 {
    /// Nível hierárquico
    pub nivel: u16,
...
impl_sped_record_trait!(RegistroD205);

impl SpedParser for RegistroD205 {
    type Output = RegistroD205;

    fn parse_reg(file_path: &Path, line_number: usize, fields: &[&str]) -> EFDResult<Self::Output> {
        let len: usize = fields.len();

        // O registro D205 possui 7 campos de dados + 2 delimitadores = 9.
        if len != 9 {
