...
impl SpedParser for RegistroD605 {
    ...
    fn parse_reg(file_path: &Path, line_number: usize, fields: &[&str]) -> EFDResult<Self::Output> {
        ...
        let cod_class = fields.get(2).to_arc();
        ...
        let cod_cta = fields.get(9).to_arc();
