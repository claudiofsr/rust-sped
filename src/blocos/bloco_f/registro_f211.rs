...
const REGISTRO: &str = "F211";

#[derive(Debug, Clone)]
pub struct RegistroF211 {
    /// Nível hierárquico
    pub nivel: u16,
...
impl_reg_methods!(RegistroF211);

impl SpedParser for RegistroF211 {
    type Output = RegistroF211;
