...
const REGISTRO: &str = "M510";

#[derive(Debug, Clone)]
pub struct RegistroM510 {
    /// Nível hierárquico
    pub nivel: u16,
...
impl_sped_record_trait!(RegistroM510);

impl SpedParser for RegistroM510 {
    type Output = RegistroM510;

    fn parse_reg(file_path: &Path, line_number: usize, fields: &[&str]) -> EFDResult<Self::Output> {
        let len: usize = fields.len();

        // O registro M510 possui 7 campos de dados + 2 delimitadores = 9.
        if len != 9 {
