...
const REGISTRO: &str = "M110";

#[derive(Debug, Clone)]
pub struct RegistroM110 {
    /// Nível hierárquico
    pub nivel: u16,
...
impl_sped_record_trait!(RegistroM110);

impl SpedParser for RegistroM110 {
    type Output = RegistroM110;

    fn parse_reg(file_path: &Path, line_number: usize, fields: &[&str]) -> EFDResult<Self::Output> {
        let len: usize = fields.len();

        // O registro M110 possui 7 campos de dados + 2 delimitadores = 9.
        if len != 9 {
