...
impl TipoDeRateio {
    /// Converte u16 para o Enum de forma segura
...
pub enum TipoDeCredito {
    ...
    #[serde(rename = "")] // Vazio retorna string vazia
    Vazio = 100,
}
...
impl TipoDeCredito {
    ...
    pub fn descricao_com_codigo(&self) -> String {
        match self {
            Self::Vazio => String::new(),
            // *self as u16 funciona pois temos #[repr(u16)]
            _ => format!("{:02} - {}", *self as u16, self),
        }
    }
}
...
static TIPOS_DOS_ITENS: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
