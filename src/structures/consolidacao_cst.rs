...
use crate::{
    display_cst, display_f64, display_mes, display_value, realizar_somas_trimestrais,
    serialize_cst, serialize_mes, verificar_periodo_multiplo, Despise, DocsFiscais, InfoExtension,
    MyResult, ZERO,
};
...
pub fn consolidar_operacoes_por_cst(
    linhas: &[DocsFiscais],
) -> MyResult<(String, Vec<ConsolidacaoCST>)> {
