...
use efd_contribuicoes::{
    Chaves, DocsFiscais, MesesDoAno, TipoDeCredito, TipoDeOperacao, Valores, obter_chaves_valores,
};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    for number_of_lines in list {
        ...
        for index in 1..=number_of_lines {
            ...
            colunas.cst = efd_contribuicoes::CodigoSituacaoTributaria::from_u16(cst as u16);
