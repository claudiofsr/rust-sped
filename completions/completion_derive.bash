_efd_contribuicoes() {
    ...
    case "${cmd}" in
        efd_contribuicoes)
            opts="-a -c -d -e -t -f -g -o -p -n -r -h -V --all-files --clear_terminal --debug --excluir-saidas --excluir-cst-49 --find --generate --operacoes-de-creditos --print-csv --not-print-xlsx --range --help --version"
