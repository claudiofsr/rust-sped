...
complete -c efd_contribuicoes -s d -l debug -d 'Ativar mensagens de debug (ex: Correlações do Bloco M)'
...
complete -c efd_contribuicoes -s n -l not-print-xlsx -d 'Not Print XLSX (Excel) file.'
