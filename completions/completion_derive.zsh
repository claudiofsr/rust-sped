...
'*-r+[Select SPED EFD files to analyze by specifying the range.]:RANGE: ' \
'*--range=[Select SPED EFD files to analyze by specifying the range.]:RANGE: ' \
'-t+[Number of additional threads used to generate worksheets.]:THREADS: ' \
'--threads=[Number of additional threads used to generate worksheets.]:THREADS: ' \
